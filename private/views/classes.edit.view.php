        ...
        <?php if ($row) : ?>
            <form method="post">
                <div class="field smart-colleges">
                    ...
                    <?php endif; ?>
                    <h3 class="title has-text-black has-text-weight-semibold">Edit Class</h3>
                    <label for="class" class="label has-text-black">Class Name:</label>
                    <div class="control">
                        <input type="text" value="<?= get_var('class', $row[0]->class) ?>" id="class" name="class" class="input has-background-white has-text-black" autocomplete="off" autofocus>
